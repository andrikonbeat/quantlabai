...
def get_tab_for_field(field_name: str) -> str:
    """Map a BuildConfig field name to its SQX tab name.

    Args:
        field_name: The BuildConfig dataclass field name.

    Returns:
        The SQX tab name (e.g. "MoneyManagement", "Ranking", "What to build").
    """
