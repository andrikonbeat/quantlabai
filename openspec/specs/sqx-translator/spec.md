# SQX Translator Specification

## Purpose

Translates Research DSL configuration models into StrategyQuant `.cfx` format — a ZIP archive containing multiple XML files (config.xml + task XML files) that SQX can execute.
